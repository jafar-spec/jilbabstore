    ...
    <main>
      ...
      <div style={{ paddingTop: '100px', minHeight: '60vh', maxWidth: '800px', margin: '0 auto', padding: '120px 20px 40px', lineHeight: '1.8' }}>
        ...
        <div style={{ background: 'var(--surface-color)', padding: '2rem', borderRadius: '15px', border: '1px solid var(--glass-border)' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>2. תשלומים ואבטחת מידע</h2>
            <p>איננו אוספים ואיננו שומרים פרטי כרטיסי אשראי בשרתינו. התשלום מתבצע בעת קבלת ההזמנה (מזומן לשליח) או באמצעות PayPal בסביבה מאובטחת ומוצפנת. נתוני ההזמנה נשמרים באופן מאובטח ומשמשים לצורך טיפול בהזמנה בלבד.</p>
          </section>
          ...
          <section style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>4. עוגיות (Cookies)</h2>
            <p>אנו משתמשים בעוגיות חיוניות להפעלת האתר (עגלת קניות, העדפות) ובעוגיות אנליטיקה לשיפור החוויה. עוגיות אנליטיקה נטענות רק לאחר קבלת הסכמתך בבאנר העוגיות, וניתן לסרב להן בכל עת.</p>
          </section>

          <section>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>5. זכויות המשתמש</h2>
