...
// IMPORTANT: initialize App Check BEFORE any Firestore/Storage/Auth request so
// every request carries a token. Doing this at module load (synchronously, on
// the client) — rather than in a React effect — guarantees the provider is
// registered before the storefront's first reads fire. Runs once per app.
